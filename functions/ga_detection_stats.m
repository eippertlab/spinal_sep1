    ...
    case 1
        ...
        for istim = 1:stim_types
            for ichan = 1:size(chan_names,2)
                ...
                snr_ind.(chan_names{ichan}) = tmp_snr;
                clear tmp*
            ...
            % save individual snr
            if strcmp('mixed', str_stimulation)
                fname_snr = [savepath_ga 'stats_ind_snr_' cond_name '.mat'];
            else
                fname_snr = [savepath_ga 'stats_ind_snr_' cond_name '_' extension_conds{istim} '.mat'];
            end
            save(fname_snr,'snr_ind')
        end
