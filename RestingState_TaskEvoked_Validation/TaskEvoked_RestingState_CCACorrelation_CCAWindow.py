...
# Crop each evoked array of the 1000 to the time window used for CCA training
    ...
    for data_type in ['spinal']:  # 'cortical'
        for condition in conditions:
            ...
            for subject in subjects:
                ...
                figure_path = f"/data/p_02569/CCA_Validation/{figure_folder}/CCA_RS_Task_CCAWindow/{data_type}/"
                ...
                indices = [int((sfreq*0.1) + (window_times[0])*sfreq), int((sfreq*0.1) + (window_times[1])*sfreq)]
